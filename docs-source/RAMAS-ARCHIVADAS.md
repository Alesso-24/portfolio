...
| `restore/sitio-icono-kicad-2026-09-21` | `e01388b` | `main` con el **ícono oficial y el logo modernizado de KiCad** desplegados (PR #71) | `git checkout -b volver restore/sitio-icono-kicad-2026-09-21` |
...
**Liquid Glass v2 (2026-09-21), integradas y borradas:** `docs/liquid-glass-refraccion` #66 · `feat/glass-refraction` #67 · `feat/glass-rim` #68 · `fix/glass-refraction-qa` #69 · `docs/cierre-glass-v2` #70 · `feat/kicad-icono-oficial` #71.
