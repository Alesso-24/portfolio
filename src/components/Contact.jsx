  ...
  return (
    <section id="contact" className="py-32 px-4 md:px-8 bg-brand-dark min-h-screen flex flex-col justify-between relative overflow-hidden border-t border-brand-primary/5">
      ...
      <div className="max-w-7xl mx-auto w-full flex-grow flex flex-col justify-center py-20">
        ...
        <h2 className="font-display font-light text-[10vw] md:text-[8vw] leading-none tracking-tight text-brand-primary text-center transition-all duration-300 mb-16 opacity-90">
      ...
      <div className="max-w-7xl mx-auto w-full mt-24 flex flex-col md:flex-row gap-6 justify-center items-center font-sans font-light text-[10px] text-brand-primary/40 uppercase tracking-[0.1em] border-t border-brand-primary/10 pt-10 z-10 pb-4">
