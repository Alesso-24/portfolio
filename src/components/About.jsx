...
const About = () => {
  ...
  const text = "Como estudiante de Ingeniería Mecatrónica, me enfoco en diseñar sistemas que integren hardware y software de forma eficiente y robusta. Tengo experiencia en robótica, diseño de PCBs, visión artificial y la implementación de Machine Learning en dispositivos embebidos (Edge AI). Mi objetivo es desarrollar soluciones tecnológicas para problemas complejos. Fuera del laboratorio, dedico mi tiempo a estudiar alemán y tocar la guitarra clásica.";
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        <div className="mb-16">
            <h2 className="font-display font-medium text-4xl md:text-5xl text-brand-primary tracking-tight">
                Profile<span className="text-brand-accent">.</span>
            </h2>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            <div className="col-span-1 lg:col-span-2 glass-panel p-8 md:p-12 rounded-3xl relative overflow-hidden group hover:border-brand-primary/10 transition-colors duration-500">
                ...
                <h3 className="text-brand-accent text-xs mb-8 font-sans uppercase tracking-[0.2em] font-medium">About Me</h3>
            ...
            <div className="glass-panel p-8 md:p-10 rounded-3xl flex flex-col justify-between hover:border-brand-primary/10 transition-colors duration-500">
                <div>
                   <h3 className="text-brand-accent text-xs mb-8 font-sans uppercase tracking-[0.2em] font-medium">Focus Areas</h3>
                   <ul className="space-y-4 font-sans font-medium text-[15px] text-brand-primary/80">
                        <li className="flex items-center gap-3"><span className="w-1.5 h-1.5 bg-brand-accent rounded-full"></span> Intelligent Systems</li>
                        <li className="flex items-center gap-3"><span className="w-1.5 h-1.5 bg-brand-accent rounded-full"></span> Hardware Integration</li>
                        <li className="flex items-center gap-3"><span className="w-1.5 h-1.5 bg-brand-accent rounded-full"></span> Machine Learning</li>
                        <li className="flex items-center gap-3"><span className="w-1.5 h-1.5 bg-brand-accent rounded-full"></span> Control Systems</li>
                   </ul>
                </div>
                <div className="pt-8 mt-8 border-t border-brand-primary/10">
                    <p className="font-sans font-medium text-xs uppercase tracking-widest text-brand-primary/60">Actualmente disponible para oportunidades</p>
                </div>
            </div>
            ...
            <div className="col-span-1 lg:col-span-3 glass-panel p-8 md:p-10 rounded-3xl flex flex-col md:flex-row justify-between items-center gap-8 hover:border-brand-primary/10 transition-colors duration-500">
                <div className="w-full">
                    <h3 className="text-brand-accent text-xs mb-8 font-sans uppercase tracking-[0.2em] font-medium">Tech Stack</h3>
                    <div className="flex flex-wrap gap-2">
                        {['Robótica', 'C/C++', 'Python', 'Machine Learning', 'ESP32', 'Visión Artificial', 'React', 'TailwindCSS'].map((skill, i) => (
